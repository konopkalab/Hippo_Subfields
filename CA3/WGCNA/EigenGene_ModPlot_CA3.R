...
tab=read.table("CA3_Matrix_module_correlation.txt")
...
pdf("Module_Eigengene_CoolMod_CA3.pdf",width=4.5,height=2.5,useDingbats=FALSE)
...
labs(title="CA1 Module EigenGene",x="", y = "Eigengene")
dev.off()
