...
vec <- c("0-869","0-870","0-871","0-872","0-873","0-882","0-883","0-884","0-885","0-886")
...
pdf("CA3_Variance_Explained.pdf",width=4,height=4)
plotVarExp(var,"CA3 VarExp")
dev.off()
...
theme_classic() +
ggsave("CA3_Top20genes_VarExp.pdf", width=6, height=5)

plotVarPart(vp) +
theme_classic() +
ggsave("CA3_AllGene_Explained.pdf", width=6, height=5)

# SVA calculation
mod = model.matrix(~Diagnosis+Sex+Age+PMI+RIN+Batch, data =pd)
...
pdf("CA3_Heatmap.pdf",width=6,height=6)
