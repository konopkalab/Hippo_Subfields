...
pdf("DG_Variance_Explained_DRUGS.pdf",width=4,height=4)
plotVarExp(var,"DG DRUGS VarExp")
dev.off()
...
theme_classic() +
ggsave("DG_Top8genes_VarExp_DRUGS.pdf", width=6, height=5)

plotVarPart(vp) +
theme_classic() +
ggsave("DG_AllGene_Explained_DRUGS.pdf", width=6, height=5)
...
pdf("DG_DRUGS_Heatmap.pdf",width=6,height=6)
